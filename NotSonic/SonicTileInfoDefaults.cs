...
namespace NotSonic
{
    class SonicTileInfoDefaults
    {
        ...
        // Loop Up --- wall counterparts are Loop Down (Left to floor) of the same kind
        ...
        // Loop Down
        public static SonicTileInfo TILEINFO_LOOP_DOWN_10 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_10, HeightArrays.HEIGHT_LOOP_UP_10, 360 - 90);
        public static SonicTileInfo TILEINFO_LOOP_DOWN_20 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_20, HeightArrays.HEIGHT_LOOP_UP_20, 360 - 70);
        public static SonicTileInfo TILEINFO_LOOP_DOWN_30 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_30, HeightArrays.HEIGHT_LOOP_UP_30, 360 - 60);
        public static SonicTileInfo TILEINFO_LOOP_DOWN_45 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_45, HeightArrays.HEIGHT_LOOP_UP_45, 360 - 45);
        public static SonicTileInfo TILEINFO_LOOP_DOWN_60 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_60, HeightArrays.HEIGHT_LOOP_UP_60, 360 - 30);
        public static SonicTileInfo TILEINFO_LOOP_DOWN_70 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_70, HeightArrays.HEIGHT_LOOP_UP_70, 360 - 20);
        public static SonicTileInfo TILEINFO_LOOP_DOWN_85 = new SonicTileInfo(HeightArrays.HEIGHT_LOOP_DOWN_85, HeightArrays.HEIGHT_LOOP_UP_85, 360 - 15);
    }
}
